unit MCKGRushRadioBoxEditor;

//  file: MCKGRushRadioBoxEditor.pas
//  file version: 0.35
...
type
    TRadioBoxStylesProp = class(TClassProperty)
    public
...
{$I MCKfakeClasses.inc}
    PRadioBoxEditor = ^TRadioBoxEditor;
    TRadioBoxEditor = object(TObj)
        Form: PControl;
        ...
        Control: TKOLGRushCheckBox;
        Label32: TKOLLabel;
        ColorCheck: TKOLLabel;
        GRushButton21: TKOLGRushButton;
        Label33: TKOLLabel;
        CheckMetric: TKOLEditBox;
        GRushButton22: TKOLGRushButton;
        ///////////////////
        ActiveWindow: HWnd;
        WindowList: Pointer;
        Prop: TRadioBoxStylesProp;
        Styles: TKOLGRushRadioBoxStyles;
        Component: MCKGRushControls.TKOLGRushRadioBox;
        ...
        procedure CheckMetricLeave(Sender: PObj);
        procedure GRushButton22Click(Sender: PObj);
        procedure ColorCheckClick(Sender: PObj);
        procedure GRushButton21Click(Sender: PObj);
    private
    public
    end;

var RadioBoxEditor: PRadioBoxEditor;

procedure Register;
procedure NewRadioBoxEditor(var Result: PRadioBoxEditor; Prop: TRadioBoxStylesProp);

implementation

procedure Register;
begin
    RegisterPropertyEditor(TypeInfo(TKOLGRushRadioBoxStyles), nil, '', TRadioBoxStylesProp);
end;
...
begin
    ...
    New(Result, Create);
    Result.Form := NewForm(nil, 'RadioBoxEditor').SetPosition(221, 110).SetClientSize(520, 561);
    ...
    Result.ButtonCancel := PGRushControl(NewGRushButton(Result.Form, 'Cancel').SetPosition(400, 504).SetSize(105, 33));
    ...
    Result.GRushPanel1 := PGRushControl(NewGRushPanel(Result.Form).SetPosition(8, 160).SetSize(249, 393));
    ...
    Result.ColorCheck := NewLabel(Result.GRushPanel1, '').SetPosition(128, 104).SetSize(49, 17);
    Result.ColorCheck.Color := clSilver;
    Result.Label16 := NewLabel(Result.GRushPanel1, 'L:').SetPosition(8, 320).SetSize(17, 17);
    Result.Label16.TextAlign := taRight;
    Result.Label16.Color := $E8D6CE;
    Result.Label17 := NewLabel(Result.GRushPanel1, 'T:').SetPosition(68, 320).SetSize(17, 17);
    Result.Label17.TextAlign := taRight;
    Result.Label17.Color := $E8D6CE;
    Result.Label18 := NewLabel(Result.GRushPanel1, 'Offsets of content').SetPosition(8, 296).SetSize(185, 17);
    Result.Label18.Font.FontStyle := [fsBold];
    Result.Label18.TextAlign := taCenter;
    Result.Label18.Color := $E8D6CE;
    Result.Label19 := NewLabel(Result.GRushPanel1, 'R:').SetPosition(128, 320).SetSize(17, 17);
    Result.Label19.TextAlign := taRight;
    Result.Label19.Color := $E8D6CE;
    Result.Label20 := NewLabel(Result.GRushPanel1, 'B:').SetPosition(188, 320).SetSize(17, 17);
    Result.Label20.TextAlign := taRight;
    Result.Label20.Color := $E8D6CE;
    Result.Label21 := NewLabel(Result.GRushPanel1, 'Spacing:').SetPosition(8, 344).SetSize(97, 17);
    Result.Label21.TextAlign := taRight;
    Result.Label21.Color := $E8D6CE;
    Result.Label22 := NewLabel(Result.GRushPanel1, 'Glyph size').SetPosition(8, 248).SetSize(185, 17);
    Result.Label22.Font.FontStyle := [fsBold];
    Result.Label22.TextAlign := taCenter;
    Result.Label22.Color := $E8D6CE;
    Result.Label23 := NewLabel(Result.GRushPanel1, 'width:').SetPosition(8, 272).SetSize(65, 17);
    Result.Label23.TextAlign := taRight;
    Result.Label23.Color := $E8D6CE;
    Result.Label24 := NewLabel(Result.GRushPanel1, 'height:').SetPosition(128, 272).SetSize(65, 17);
    Result.Label24.TextAlign := taRight;
    Result.Label24.Color := $E8D6CE;
    Result.Label25 := NewLabel(Result.GRushPanel1, 'Update speed:').SetPosition(8, 368).SetSize(97, 17);
    Result.Label25.TextAlign := taRight;
    Result.Label25.Color := $E8D6CE;
    Result.Label26 := NewLabel(Result.GRushPanel1, 'Glyph align').SetPosition(8, 152).SetSize(185, 17);
    Result.Label26.Font.FontStyle := [fsBold];
    Result.Label26.TextAlign := taCenter;
    Result.Label26.Color := $E8D6CE;
    Result.Label27 := NewLabel(Result.GRushPanel1, 'horz:').SetPosition(8, 176).SetSize(49, 17);
    Result.Label27.TextAlign := taRight;
    Result.Label27.Color := $E8D6CE;
    Result.Label28 := NewLabel(Result.GRushPanel1, 'vert:').SetPosition(128, 176).SetSize(49, 17);
    Result.Label28.TextAlign := taRight;
    Result.Label28.Color := $E8D6CE;
    Result.Label29 := NewLabel(Result.GRushPanel1, 'Text align').SetPosition(8, 200).SetSize(185, 17);
    Result.Label29.Font.FontStyle := [fsBold];
    Result.Label29.TextAlign := taCenter;
    Result.Label29.Color := $E8D6CE;
    Result.Label30 := NewLabel(Result.GRushPanel1, 'horz:').SetPosition(8, 224).SetSize(49, 17);
    Result.Label30.TextAlign := taRight;
    Result.Label30.Color := $E8D6CE;
    Result.Label31 := NewLabel(Result.GRushPanel1, 'vert:').SetPosition(128, 224).SetSize(49, 17);
    Result.Label31.TextAlign := taRight;
    Result.Label31.Color := $E8D6CE;
    Result.Label32 := NewLabel(Result.GRushPanel1, 'Check color:').SetPosition(8, 104).SetSize(97, 17);
    Result.Label32.TextAlign := taRight;
    Result.Label32.Color := $E8D6CE;
    Result.Label33 := NewLabel(Result.GRushPanel1, 'Size of check:').SetPosition(8, 128).SetSize(97, 17);
    Result.Label33.TextAlign := taRight;
    ...
    Result.GRushPanel3 := PGRushControl(NewGRushPanel(Result.Form).SetPosition(7, 8).SetSize(249, 145));
    ...
    Result.Caption := NewEditBox(Result.GRushPanel3, []).SetPosition(8, 120).SetSize(233, 17);
    Result.Caption.Ctl3D := False;
    Result.Caption.Font.FontStyle := [];
    Result.Caption.Text := 'Button control';
    Result.Control := PGRushControl(NewGRushRadioBox(Result.GRushPanel3, 'CheckBox1').SetPosition(8, 24).SetSize(233, 65));
    Result.Control.DoubleBuffered := True;
    Result.CheckEnabled := PGRushControl(NewGRushCheckBox(Result.GRushPanel3, 'Enabled').SetPosition(8, 96).SetSize(113, 17));
    ...
    Result.CheckTransparent := PGRushControl(NewGRushCheckBox(Result.GRushPanel3, 'Transparent').SetPosition(128, 96).SetSize(113, 17));
    ...
    with Result^ do begin
        Styles := TKOLGRushRadioBoxStyles(Prop.GetOrdValue);
        Component := (Styles.Owner as MCKGRushControls.TKOLGRushRadioBox);
    ...
    Result.ColorCheck.OnClick := Result.ColorCheckClick;
    Result.ColorCheck.OnPaint := Result.Col1Paint;
    ...
    Result.CheckMetric.Color := clWindow;
    Result.CheckMetric.OnEnter := Result.BorderWiEnter;
    Result.CheckMetric.OnLeave := Result.CheckMetricLeave;
...
procedure TRadioBoxEditor.KOLForm1BeforeCreateWindow(Sender: PObj);
begin
    Form.Font;
end;

procedure TRadioBoxEditor.KOLForm1FormCreate(Sender: PObj);
begin
    ...
    CheckMetric.Caption := int2str(Control.All_CheckMetric);
    ColorCheck.Color := Control.All_ColorCheck;
end;

procedure TRadioBoxEditor.Down1Click(Sender: PObj);
begin
    StatesList.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.Down2Click(Sender: PObj);
begin
    GradStyles.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.CheckEnabledClick(Sender: PObj);
begin
    Control.Enabled := CheckEnabled.Checked;
end;

procedure TRadioBoxEditor.CheckTransparentClick(Sender: PObj);
begin
    Control.Transparent := CheckTransparent.Checked;
    Control.Invalidate;
end;

procedure TRadioBoxEditor.Down3Click(Sender: PObj);
begin
    UpdateSpeed.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.Down4Click(Sender: PObj);
begin
    GlyphHorz.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.Down5Click(Sender: PObj);
begin
    GlyphVert.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.Down6Click(Sender: PObj);
begin
    TextHorz.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.Down7Click(Sender: PObj);
begin
    TextVert.DroppedDown := TRUE;
end;

procedure TRadioBoxEditor.GradStylesSelChange(Sender: PObj);
begin
...
procedure TRadioBoxEditor.Col1Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.Col2Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.Col3Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.Col4Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.Col5Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.Col6Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.StatesListSelChange(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.UpdateSpeedSelChange(Sender: PObj);
begin
    Control.All_UpdateSpeed := TGRushSpeed(UpdateSpeed.CurIndex);
end;

procedure TRadioBoxEditor.AntiAliasingClick(Sender: PObj);
begin
...
procedure TRadioBoxEditor.DrawFocusClick(Sender: PObj);
begin
    Control.All_DrawFocusRect := DrawFocus.Checked;
    Control.Invalidate;
end;

procedure TRadioBoxEditor.DrawGlyphClick(Sender: PObj);
begin
...
procedure TRadioBoxEditor.DrawTextClick(Sender: PObj);
begin
...
procedure TRadioBoxEditor.CaptionChange(Sender: PObj);
begin
    Control.Caption := Caption.Text;
end;

procedure TRadioBoxEditor.GlyphHorzSelChange(Sender: PObj);
begin
...
procedure TRadioBoxEditor.TextHorzSelChange(Sender: PObj);
begin
...
procedure TRadioBoxEditor.Col1Paint(Sender: PControl; DC: HDC);
var TR: TRect;
    BR: HBRUSH;
begin
...
procedure TRadioBoxEditor.CheckEnabledRecalcRects(Sender: PGRushControl;
    var Rects: TGrushRects);
begin
    OffsetRect(Rects.DownBorderRect, 1, 1);
end;

procedure TRadioBoxEditor.BorderWiEnter(Sender: PObj);
begin
    Sender.Tag := DWORD(str2int(PControl(Sender).Text));
end;

procedure TRadioBoxEditor.BorderWiLeave(Sender: PObj);
var Val: DWORD;
begin
...
procedure TRadioBoxEditor.BorderHeLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.GlyphXLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.GlyphYLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.GlyphWidthLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.GlyphHeightLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.SpacingLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.LLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TRadioBoxEditor.TLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TRadioBoxEditor.RLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TRadioBoxEditor.BLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TRadioBoxEditor.ShadowOffsetLeave(Sender: PObj);
var Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Integer(Sender.tag) then exit;
...
procedure TRadioBoxEditor.BorderWidthLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TRadioBoxEditor.GRushButton11Click(Sender: PObj);
begin
...
procedure TRadioBoxEditor.GRushButton12Click(Sender: PObj);
begin
    TextHorz.CurIndex := 0;
    Control.All_TextHAlign := haLeft;
    TextVert.CurIndex := 1;
    Control.All_TextVAlign := vaCenter;
    Control.Invalidate;
end;

procedure TRadioBoxEditor.GRushButton16Click(Sender: PObj);
begin
    L.Text := '19';
    T.Text := '1';
    R.Text := '-1';
    B.Text := '-1';
    Control.All_ContentOffsets := MakeRect(19, 1, -1, -1);
    Control.Invalidate;
end;

procedure TRadioBoxEditor.GRushButton17Click(Sender: PObj);
begin
    Spacing.Text := '5';
...
procedure TRadioBoxEditor.GRushButton19Click(Sender: PObj);
begin
...
procedure TRadioBoxEditor.GRushButton13Click(Sender: PObj);
begin
    GlyphWidth.Text := '0';
...
procedure TRadioBoxEditor.GRushButton10Click(Sender: PObj);
begin
    GlyphX.Text := '0';
    GlyphY.Text := '0';
    case StatesList.CurIndex of
...
procedure TRadioBoxEditor.GRushPanel3MouseDown(Sender: PControl;
    var Mouse: TMouseEventData);
begin
...
procedure TRadioBoxEditor.GRushButton9Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
                Control.Def_BorderRoundWidth := 50;
                Control.Def_BorderRoundHeight := 50;
                BorderWi.Text := '50';
                BorderHe.Text := '50';
            end;
        2:
            begin
                Control.Over_BorderRoundWidth := 50;
                Control.Over_BorderRoundHeight := 50;
                BorderWi.Text := '50';
                BorderHe.Text := '50';
            end;
        3:
            begin
                Control.Down_BorderRoundWidth := 50;
                Control.Down_BorderRoundHeight := 50;
                BorderWi.Text := '50';
                BorderHe.Text := '50';
            end;
        4:
            begin
                Control.Dis_BorderRoundWidth := 50;
                Control.Dis_BorderRoundHeight := 50;
                BorderWi.Text := '50';
                BorderHe.Text := '50';
            end;
        0:
            begin
                Control.All_BorderRoundWidth := 50;
                Control.All_BorderRoundHeight := 50;
                BorderWi.Text := '0';
                BorderHe.Text := '0';
            end;
    end;
...
procedure TRadioBoxEditor.GRushButton8Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton7Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton18Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
                Control.Def_GradientStyle := gsFromTopLeft;
                GradStyles.CurIndex := 5;
            end;
        2:
            begin
                Control.Over_GradientStyle := gsFromTopLeft;
                GradStyles.CurIndex := 5;
            end;
        3:
            begin
                Control.Down_GradientStyle := gsFromTopLeft;
                GradStyles.CurIndex := 5;
            end;
        4:
            begin
        ...
        0:
            begin
                Control.All_GradientStyle := gsFromTopLeft;
                GradStyles.CurIndex := 0;
            end;
    end;
    Control.Invalidate;
...
procedure TRadioBoxEditor.GRushButton1Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton2Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton3Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton4Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
                Control.Def_BorderColor := clGray;
                Col4.Color := clGray;
            end;
        2:
            begin
                Control.Over_BorderColor := $404040;
                Col4.Color := $404040;
            end;
        3:
            begin
...
procedure TRadioBoxEditor.GRushButton5Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton6Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TRadioBoxEditor.GRushButton14Click(Sender: PObj);
begin
...
procedure TRadioBoxEditor.GRushButton20Click(Sender: PObj);
begin
    ...
    KOLForm1FormCreate(RadioBoxEditor);
    Control.Invalidate;
end;

procedure TRadioBoxEditor.KOLForm1Close(Sender: PObj; var Accept: Boolean);
begin
    Accept := TRUE;
...
procedure TRadioBoxEditor.GRushButton15Click(Sender: PObj);
var     Data: PGRushData;
begin
    ...
    Data.fCheckMetric :=                Styles.CheckMetric;
    Data.fColorCheck :=                 Styles.ColorCheck;
...
procedure TRadioBoxEditor.ButtonOKClick(Sender: PObj);
var     Data: PGRushData;
begin
    Data := PGRushData(Control.CustomObj);

    Styles.ColorCheck :=                            Data.fColorCheck;
    Styles.CheckMetric :=                           Data.fCheckMetric;
...
procedure TRadioBoxEditor.ButtonCancelClick(Sender: PObj);
begin
    Form.Close;
end;

procedure TRadioBoxEditor.CropTopFirstClick(Sender: PObj);
begin
end;

procedure TRadioBoxEditor.GlyphAttachedClick(Sender: PObj);
begin
end;

procedure TRadioBoxEditor.WordWrapClick(Sender: PObj);
begin
end;

procedure TRadioBoxEditor.CheckMetricLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
    Control.All_CheckMetric := Val;
    L.Text := int2str(Control.All_ContentOffsets.Left);
    Control.Invalidate;
end;

procedure TRadioBoxEditor.GRushButton22Click(Sender: PObj);
begin
    Control.All_CheckMetric := 13;
    CheckMetric.Caption := '13';
    L.Text := int2str(Control.All_ContentOffsets.Left);
    Control.Invalidate;
end;

procedure TRadioBoxEditor.ColorCheckClick(Sender: PObj);
begin
    CD1.Color := Control.All_ColorCheck;
    if CD1.Execute then
        Control.All_ColorCheck := CD1.Color;
    Control.Invalidate;
end;

procedure TRadioBoxEditor.GRushButton21Click(Sender: PObj);
begin
    ColorCheck.Color := $F3706C;
    Control.All_ColorCheck := $F3706C;
end;



function TRadioBoxStylesProp.GetAttributes: TPropertyAttributes;
begin
    Result := [paMultiSelect, paSubProperties, paDialog, paReadOnly];
end;

procedure TRadioBoxStylesProp.Edit;
var     Styles: TKOLGRushRadioBoxStyles;
begin
    Styles := TKOLGRushRadioBoxStyles(GetOrdValue);
    if Styles = nil then exit;
    if not (Styles is TKOLGRushRadioBoxStyles) then exit;

    RadioBoxEditor := nil;
    AppletTerminated := FALSE;
    try
        NewRadioBoxEditor(RadioBoxEditor, Self);
        RadioBoxEditor.ActiveWindow := GetActiveWindow;
        RadioBoxEditor.WindowList := DisableTaskWindows(0);
        KOL.Run(KOL.Applet);
    finally
    end;
end;
