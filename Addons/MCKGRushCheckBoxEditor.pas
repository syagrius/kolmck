unit MCKGRushCheckBoxEditor;

//  file: MCKGRushCheckBoxEditor.pas
//  file version: 0.35
...
type
    TCheckBoxStylesProp = class(TClassProperty)
    public
...
{$I MCKfakeClasses.inc}
    PCheckBoxEditor = ^TCheckBoxEditor;
    TCheckBoxEditor = object(TObj)
        Form: PControl;
        ...
        ActiveWindow: HWnd;
        WindowList: Pointer;
        Prop: TCheckBoxStylesProp;
        Styles: TKOLGRushCheckBoxStyles;
        Component: MCKGRushControls.TKOLGRushCheckBox;
...
var CheckBoxEditor: PCheckBoxEditor;

procedure Register;
procedure NewCheckBoxEditor(var Result: PCheckBoxEditor; Prop: TCheckBoxStylesProp);

implementation

procedure Register;
begin
    RegisterPropertyEditor(TypeInfo(TKOLGRushCheckBoxStyles), nil, '', TCheckBoxStylesProp);
end;
...
begin
    ...
    New(Result, Create);
    Result.Form := NewForm(nil, 'CheckBoxEditor').SetPosition(221, 110).SetClientSize(520, 561);
    ...
    Result.Control := PGRushControl(NewGRushCheckBox(Result.GRushPanel3, 'CheckBox1').SetPosition(8, 24).SetSize(233, 65));
    ...
    with Result^ do begin
        Styles := TKOLGRushCheckBoxStyles(Prop.GetOrdValue);
        Component := (Styles.Owner as MCKGRushControls.TKOLGRushCheckBox);
...
procedure TCheckBoxEditor.KOLForm1BeforeCreateWindow(Sender: PObj);
begin
    Form.Font;
end;

procedure TCheckBoxEditor.KOLForm1FormCreate(Sender: PObj);
begin
...
procedure TCheckBoxEditor.Down1Click(Sender: PObj);
begin
    StatesList.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.Down2Click(Sender: PObj);
begin
    GradStyles.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.CheckEnabledClick(Sender: PObj);
begin
    Control.Enabled := CheckEnabled.Checked;
end;

procedure TCheckBoxEditor.CheckTransparentClick(Sender: PObj);
begin
    Control.Transparent := CheckTransparent.Checked;
    Control.Invalidate;
end;

procedure TCheckBoxEditor.Down3Click(Sender: PObj);
begin
    UpdateSpeed.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.Down4Click(Sender: PObj);
begin
    GlyphHorz.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.Down5Click(Sender: PObj);
begin
    GlyphVert.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.Down6Click(Sender: PObj);
begin
    TextHorz.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.Down7Click(Sender: PObj);
begin
    TextVert.DroppedDown := TRUE;
end;

procedure TCheckBoxEditor.GradStylesSelChange(Sender: PObj);
begin
...
procedure TCheckBoxEditor.Col1Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.Col2Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.Col3Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.Col4Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.Col5Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.Col6Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.StatesListSelChange(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.UpdateSpeedSelChange(Sender: PObj);
begin
    Control.All_UpdateSpeed := TGRushSpeed(UpdateSpeed.CurIndex);
end;

procedure TCheckBoxEditor.AntiAliasingClick(Sender: PObj);
begin
...
procedure TCheckBoxEditor.DrawFocusClick(Sender: PObj);
begin
    Control.All_DrawFocusRect := DrawFocus.Checked;
    Control.Invalidate;
end;

procedure TCheckBoxEditor.DrawGlyphClick(Sender: PObj);
begin
...
procedure TCheckBoxEditor.DrawTextClick(Sender: PObj);
begin
...
procedure TCheckBoxEditor.CaptionChange(Sender: PObj);
begin
    Control.Caption := Caption.Text;
end;

procedure TCheckBoxEditor.GlyphHorzSelChange(Sender: PObj);
begin
...
procedure TCheckBoxEditor.TextHorzSelChange(Sender: PObj);
begin
...
procedure TCheckBoxEditor.Col1Paint(Sender: PControl; DC: HDC);
var TR: TRect;
    BR: HBRUSH;
begin
...
procedure TCheckBoxEditor.CheckEnabledRecalcRects(Sender: PGRushControl;
    var Rects: TGrushRects);
begin
    OffsetRect(Rects.DownBorderRect, 1, 1);
end;

procedure TCheckBoxEditor.BorderWiEnter(Sender: PObj);
begin
    Sender.Tag := DWORD(str2int(PControl(Sender).Text));
end;

procedure TCheckBoxEditor.BorderWiLeave(Sender: PObj);
var Val: DWORD;
begin
...
procedure TCheckBoxEditor.BorderHeLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.GlyphXLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.GlyphYLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.GlyphWidthLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.GlyphHeightLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.SpacingLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.LLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TCheckBoxEditor.TLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TCheckBoxEditor.RLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TCheckBoxEditor.BLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TCheckBoxEditor.ShadowOffsetLeave(Sender: PObj);
var Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Integer(Sender.tag) then exit;
...
procedure TCheckBoxEditor.BorderWidthLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.GRushButton11Click(Sender: PObj);
begin
...
procedure TCheckBoxEditor.GRushButton12Click(Sender: PObj);
begin
    TextHorz.CurIndex := 0;
...
procedure TCheckBoxEditor.GRushButton16Click(Sender: PObj);
begin
    L.Text := '19';
    T.Text := '1';
    R.Text := '-1';
...
procedure TCheckBoxEditor.GRushButton17Click(Sender: PObj);
begin
    Spacing.Text := '5';
...
procedure TCheckBoxEditor.GRushButton19Click(Sender: PObj);
begin
...
procedure TCheckBoxEditor.GRushButton13Click(Sender: PObj);
begin
    GlyphWidth.Text := '0';
...
procedure TCheckBoxEditor.GRushButton10Click(Sender: PObj);
begin
    GlyphX.Text := '0';
    GlyphY.Text := '0';
    case StatesList.CurIndex of
...
procedure TCheckBoxEditor.GRushPanel3MouseDown(Sender: PControl;
    var Mouse: TMouseEventData);
begin
...
procedure TCheckBoxEditor.GRushButton9Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton8Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton7Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton18Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton1Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton2Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton3Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton4Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton5Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton6Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TCheckBoxEditor.GRushButton14Click(Sender: PObj);
begin
...
procedure TCheckBoxEditor.GRushButton20Click(Sender: PObj);
begin
    ...
    KOLForm1FormCreate(CheckBoxEditor);
    Control.Invalidate;
end;

procedure TCheckBoxEditor.KOLForm1Close(Sender: PObj; var Accept: Boolean);
begin
    Accept := TRUE;
...
procedure TCheckBoxEditor.ButtonOKClick(Sender: PObj);
var     Data: PGRushData;
begin
    Data := PGRushData(Control.CustomObj);
...
procedure TCheckBoxEditor.ButtonCancelClick(Sender: PObj);
begin
    Form.Close;
end;

procedure TCheckBoxEditor.CropTopFirstClick(Sender: PObj);
begin
end;

procedure TCheckBoxEditor.GlyphAttachedClick(Sender: PObj);
begin
end;

procedure TCheckBoxEditor.WordWrapClick(Sender: PObj);
begin
end;

procedure TCheckBoxEditor.CheckMetricLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TCheckBoxEditor.GRushButton22Click(Sender: PObj);
begin
...
procedure TCheckBoxEditor.ColorCheckClick(Sender: PObj);
begin
...
procedure TCheckBoxEditor.GRushButton21Click(Sender: PObj);
begin
...
function TCheckBoxStylesProp.GetAttributes: TPropertyAttributes;
begin
    Result := [paMultiSelect, paSubProperties, paDialog, paReadOnly];
end;

procedure TCheckBoxStylesProp.Edit;
var     Styles: TKOLGRushCheckBoxStyles;
begin
    Styles := TKOLGRushCheckBoxStyles(GetOrdValue);
    if Styles = nil then exit;
    if not (Styles is TKOLGRushCheckBoxStyles) then exit;

    CheckBoxEditor := nil;
    AppletTerminated := FALSE;
    try
        NewCheckBoxEditor(CheckBoxEditor, Self);
        CheckBoxEditor.ActiveWindow := GetActiveWindow;
        CheckBoxEditor.WindowList := DisableTaskWindows(0);
        KOL.Run(KOL.Applet);
    finally
    end;
end;
