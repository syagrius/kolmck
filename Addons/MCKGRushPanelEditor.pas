unit MCKGRushPanelEditor;

//  file: MCKGRushPanelEditor.pas
//  file version: 0.35
...
type
    TPanelStylesProp = class(TClassProperty)
    public
...
{$I MCKfakeClasses.inc}
    PPanelEditor = ^TPanelEditor;
    TPanelEditor = object(TObj)
        Form: PControl;
        ...
        ActiveWindow: HWnd;
        WindowList: Pointer;
        Prop: TPanelStylesProp;
        Styles: TKOLGRushPanelStyles;
        Component: MCKGRushControls.TKOLGRushPanel;
        //GlyphBitmap: PBitmap;
...
var		PanelEditor: PPanelEditor;

procedure NewPanelEditor(var Result: PPanelEditor; Prop: TPanelStylesProp);

implementation

procedure Register;
begin
    RegisterPropertyEditor(TypeInfo(TKOLGRushPanelStyles), nil, '', TPanelStylesProp);
end;
...
begin
    ...
    New(Result, Create);
    Result.Form := NewForm(nil, 'PanelEditor').SetPosition(193, 124).SetClientSize(520, 523);
    ...
    Result.ButtonCancel := PGRushControl(NewGRushButton(Result.Form, 'Cancel').SetPosition(400, 464).SetSize(105, 33));
    Result.ButtonOK := PGRushControl(NewGRushButton(Result.Form, 'OK').SetPosition(272, 464).SetSize(105, 33));
    ...
    Result.GRushPanel1 := PGRushControl(NewGRushPanel(Result.Form).SetPosition(8, 208).SetSize(249, 305));
    ...
    Result.Label21 := NewLabel(Result.GRushPanel1, 'Spacing:').SetPosition(8, 272).SetSize(97, 17);
    ...
    Result.Control := PGRushControl(NewGRushPanel(Result.GRushPanel3).SetPosition(8, 24).SetSize(233, 113));
    Result.Control.Caption := 'PanelControl';
    ...
    with Result^ do begin
        Styles := TKOLGRushPanelStyles(Prop.GetOrdValue);
        Component := (Styles.Owner as MCKGRushControls.TKOLGRushPanel);
...
procedure TPanelEditor.KOLForm1BeforeCreateWindow(Sender: PObj);
begin
    Form.Font;
end;

procedure TPanelEditor.KOLForm1FormCreate(Sender: PObj);
begin
...
procedure TPanelEditor.Down1Click(Sender: PObj);
begin
    StatesList.DroppedDown := TRUE;
end;

procedure TPanelEditor.Down2Click(Sender: PObj);
begin
    GradStyles.DroppedDown := TRUE;
end;

procedure TPanelEditor.CheckEnabledClick(Sender: PObj);
begin
    Control.Enabled := CheckEnabled.Checked;
end;

procedure TPanelEditor.CheckTransparentClick(Sender: PObj);
begin
    Control.Transparent := CheckTransparent.Checked;
    Control.Invalidate;
end;

procedure TPanelEditor.Down4Click(Sender: PObj);
begin
    GlyphHorz.DroppedDown := TRUE;
end;

procedure TPanelEditor.Down5Click(Sender: PObj);
begin
    GlyphVert.DroppedDown := TRUE;
end;

procedure TPanelEditor.Down6Click(Sender: PObj);
begin
    TextHorz.DroppedDown := TRUE;
end;

procedure TPanelEditor.Down7Click(Sender: PObj);
begin
    TextVert.DroppedDown := TRUE;
end;

procedure TPanelEditor.GradStylesSelChange(Sender: PObj);
begin
...
procedure TPanelEditor.Col1Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.Col2Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.Col3Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.Col4Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.Col5Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.Col6Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.StatesListSelChange(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.AntiAliasingClick(Sender: PObj);
begin
...
procedure TPanelEditor.DrawGlyphClick(Sender: PObj);
begin
...
procedure TPanelEditor.DrawTextClick(Sender: PObj);
begin
...
procedure TPanelEditor.CaptionChange(Sender: PObj);
begin
    Control.Caption := Caption.Text;
end;

procedure TPanelEditor.GlyphHorzSelChange(Sender: PObj);
begin
...
procedure TPanelEditor.TextHorzSelChange(Sender: PObj);
begin
...
procedure TPanelEditor.Col1Paint(Sender: PControl; DC: HDC);
var TR: TRect;
    BR: HBRUSH;
begin
...
procedure TPanelEditor.CheckEnabledRecalcRects(Sender: PGRushControl;
    var Rects: TGrushRects);
begin
    OffsetRect(Rects.DownBorderRect, 1, 1);
end;

procedure TPanelEditor.BorderWiEnter(Sender: PObj);
begin
    Sender.Tag := DWORD(str2int(PControl(Sender).Text));
end;

procedure TPanelEditor.BorderWiLeave(Sender: PObj);
var Val: DWORD;
begin
...
procedure TPanelEditor.BorderHeLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.GlyphXLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.GlyphYLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.GlyphWidthLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.GlyphHeightLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.SpacingLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.LLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TPanelEditor.TLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TPanelEditor.RLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TPanelEditor.BLeave(Sender: PObj);
var TR: TRect;
    Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
...
procedure TPanelEditor.ShadowOffsetLeave(Sender: PObj);
var Val: integer;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Integer(Sender.tag) then exit;
...
procedure TPanelEditor.BorderWidthLeave(Sender: PObj);
var Val: DWORD;
begin
    Val := str2int(PControl(Sender).Text);
    if Val = Sender.tag then exit;
...
procedure TPanelEditor.GRushButton11Click(Sender: PObj);
begin
...
procedure TPanelEditor.GRushButton12Click(Sender: PObj);
begin
    TextHorz.CurIndex := 1;
    Control.All_TextHAlign := haCenter;
    TextVert.CurIndex := 0;
    Control.All_TextVAlign := vaTop;
    Control.Invalidate;
end;

procedure TPanelEditor.GRushButton16Click(Sender: PObj);
begin
    L.Text := '4';
    T.Text := '4';
    R.Text := '-4';
...
procedure TPanelEditor.GRushButton17Click(Sender: PObj);
begin
    Spacing.Text := '5';
...
procedure TPanelEditor.GRushButton13Click(Sender: PObj);
begin
    GlyphWidth.Text := '0';
...
procedure TPanelEditor.GRushButton10Click(Sender: PObj);
begin
    GlyphX.Text := '0';
    GlyphY.Text := '0';
    case StatesList.CurIndex of
...
procedure TPanelEditor.GRushPanel3MouseDown(Sender: PControl;
    var Mouse: TMouseEventData);
begin
...
procedure TPanelEditor.GRushButton9Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton8Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton7Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton18Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton1Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton2Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton3Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton4Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton5Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton6Click(Sender: PObj);
begin
    case StatesList.CurIndex of
        1:
            begin
...
procedure TPanelEditor.GRushButton14Click(Sender: PObj);
begin
...
procedure TPanelEditor.GRushButton20Click(Sender: PObj);
begin
    ...
    KOLForm1FormCreate(PanelEditor);
    Control.Invalidate;
end;

procedure TPanelEditor.KOLForm1Close(Sender: PObj; var Accept: Boolean);
begin
    Accept := TRUE;
...
procedure TPanelEditor.GRushButton15Click(Sender: PObj);
var     Data: PGRushData;
begin
...
procedure TPanelEditor.ButtonOKClick(Sender: PObj);
var     Data: PGRushData;
begin
    Data := PGRushData(Control.CustomObj);
...
procedure TPanelEditor.ButtonCancelClick(Sender: PObj);
begin
    Form.Close;
end;

procedure TPanelEditor.CropTopFirstClick(Sender: PObj);
begin
end;

procedure TPanelEditor.GlyphAttachedClick(Sender: PObj);
begin
end;

procedure TPanelEditor.WordWrapClick(Sender: PObj);
begin
end;
...
function TPanelStylesProp.GetAttributes: TPropertyAttributes;
begin
    Result := [paMultiSelect, paSubProperties, paDialog, paReadOnly];
end;

procedure TPanelStylesProp.Edit;
var     Styles: TKOLGRushPanelStyles;
begin
    Styles := TKOLGRushPanelStyles(GetOrdValue);
    if Styles = nil then exit;
    if not (Styles is TKOLGRushPanelStyles) then exit;

    PanelEditor := nil;
    AppletTerminated := FALSE;
    try
        NewPanelEditor(PanelEditor, Self);
        PanelEditor.ActiveWindow := GetActiveWindow;
        PanelEditor.WindowList := DisableTaskWindows(0);
        KOL.Run(KOL.Applet);
    finally
    end;
end;
