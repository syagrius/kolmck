...
{X-  MainThreadID: LongWord; }  { ThreadID of thread that module was initialized in }
...
var SaveDefaultSystemCodePage: Integer = -1;
...
procedure SetMultiByteConversionCodePage(CodePage: Integer);
begin
  SaveDefaultSystemCodePage := CodePage;
end;
{$ENDIF}
...
function DefaultSystemCodePage: Integer;
begin
  if (SaveCmdShow = -1) then
    SaveDefaultSystemCodePage := GetACP;
...
{X-  DefaultSystemCodePage := GetACP; converted to a function }
{$ENDIF}
