...
var
  Copyright : String='Portions Copyright (c) 1999,2006 vampir_infernal[VIP]';
...
{$IFEND}
{$IFDEF TRIAL_EDITION}
	Evaluation name 'This module was compiled with an evaluation version of Borland Delphi',
{$ENDIF}
